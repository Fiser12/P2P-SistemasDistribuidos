...
/**
 * Created by Fiser on 15/11/16.
 */
public class UtilController {
    public static String JNDINameKeepAlive = "jndi.ssdd.keepalivemessages";
    public static String JNDIReadyToStore = "jndi.ssdd.readytostoremessages";
